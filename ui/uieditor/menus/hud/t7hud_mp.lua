...
function LUI.createMenu.T7Hud_MP(InstanceRef)
	...
	local NewScoreWidget = CoD.GFScoreContainer.new(HudRef, InstanceRef)
	HudRef:addElement(NewScoreWidget)
	HudRef.GFScoreWidget = NewScoreWidget
